...
def main():
    ...
    c = conn.cursor()
    sql = "SELECT PosTheta,Redshift FROM Lightcone WHERE ((PosTheta < 3.142/2 ) AND (StellarMass > 1e10) AND (PosPhi > 0.0*(3.142/180.0) AND PosPhi < 30.0*(3.142/180.0)))"
    ...
    ax.scatter(coor[:,0]/numpy.pi*180,coor[:,1],s=0.1,marker=".")
    ax.grid(True)
